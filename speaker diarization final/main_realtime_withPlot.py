...
from viewer_realtime import PlotDiar
...
def main(filename, config, plot_specgram = False, Use_clustering_thread = True, Text_output = False):
    ...
    p = PlotDiar(thread = t, wav=wav_path, plot_specgram = plot_specgram, duration = duration+5)
...
if __name__ == "__main__":     
    ...
    filename = '3063115.wav' 
    

    main(filename, config, plot_specgram = True)
