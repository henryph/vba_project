...
MMCQ = (function() {
  ...
  ColorBox = (function() {
    ...
    // get number of pixels in the 3d box
    ...
    // check whether a pixel is in the box
  ...
  ColorMap = (function() {
    ...
    function ColorMap() {
      ...
      // use a Priority Queue to contain all the color boxes
      this.cboxes = new PriorityQueue(function(a, b) {
        
        var va, vb;
        // use volume of the box * number of pixels in the box as the Priority
        va = a.count() * a.volume();
        vb = b.count() * b.volume();
        if (va > vb) {
          return 1;
