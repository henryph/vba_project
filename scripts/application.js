...
$(document).ready(function() {
  ...
  $(".poster-picker").on("click", "a", function(event) {
    ...
    function showColorsForImage(image){
      ...
      generateColorBlocks();
        ...
        // get distance of two point in color space
      ...
      for (_j = 0; _j < _len; _j++) {
        color = palette[_j];
        dist = colorDist(bgColor, color);
        if (dist > maxDist && color !== textColor) {
          maxDist = dist;
          textColor2 = color;
        }
      }
      ...
      // This part is solely developed by PAN Hao
      ...
      $(".movie-title, .detail-title").css("color", "" + (rgbToCssString(textColor)));
      $(".movie-divider").css("border-color", "" + (rgbToCssString(textColor)));
      $(".movie-details .detail-content").css("color", "" + (rgbToCssString(textColor2)));
      return $(".movie-artist").css("color", "" + (rgbToCssString(textColor2)));
  ...
  // Function for uploading image; This part is solely developed by PAN Hao
